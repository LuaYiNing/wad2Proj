        ...
        this.list = [
            {
                ...
                imageSources:
                [
                    './models/projects/Video 1 - Food Waste The Hidden Cost/vid1pic1.webp',
                    './models/projects/Video 1 - Food Waste The Hidden Cost/vid1pic2.webp',
                    './models/projects/Video 1 - Food Waste The Hidden Cost/vid1pic3.webp',
                    './models/projects/Video 1 - Food Waste The Hidden Cost/vid1pic4.webp'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
                    href: 'https://youtu.be/ishA6kry8nc',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/Video 2 - Turn the Tables/vid2pic1.webp',
                    './models/projects/Video 2 - Turn the Tables/vid2pic2.webp',
                    './models/projects/Video 2 - Turn the Tables/vid2pic3.webp',
                ],
                floorTexture: this.resources.items.projectsChartogneFloorTexture,
                link:
                {
                    href: 'https://youtu.be/6iqXH9RPK1w',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/Video 3 - Expiration Dates/vid3pic1.webp',
                    './models/projects/Video 3 - Expiration Dates/vid3pic2.webp',
                    './models/projects/Video 3 - Expiration Dates/vid3pic3.webp',
                    './models/projects/Video 3 - Expiration Dates/vid3pic4.webp'
                ],
                floorTexture: this.resources.items.projectsBonhomme10ansFloorTexture,
                link:
                {
                    href: 'https://youtu.be/jDg8DQl7ZeQ',
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
